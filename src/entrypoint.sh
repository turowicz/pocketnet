...
if [ ! -f "/root/.pocketcoin/wallet.dat" ]; then
    ...
    transmission-cli -ep -w /root/.pocketcoin -f /kill-torrents.sh magnet:?xt=urn:btih:1ce99736ded66714ac9222f847d6497bd362e50f&dn=pocketnet.blockchain.1030752&tr=udp%3a%2f%2ftracker.openbittorrent.com%3a80%2fannounce
    tail --pid=$(pidof transmission-cli) -f /dev/null
fi
